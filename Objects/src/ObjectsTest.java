...
public class ObjectsTest {
    public static void main(String[] args) {
        ...
        System.out.println("compare(\"aa\", \"bb\", c) = " + Objects.compare("aa", "bb", c));
        System.out.println("compare(\"bb\", \"aa\", c) = " + Objects.compare("bb", "aa", c));
        System.out.println("compare(\"ab\", \"AB\", c) = " + Objects.compare("ab", "AB", c));
    }
}
